...
# ==================================================
    ...
    with col2:
        ...
        st.metric(
            "Precision",
            f"{classification_metrics['Precision']:.2%}"
        )
    ...
    with col3:
        ...
        st.metric(
            "Recall",
            f"{classification_metrics['Recall']:.2%}"
        )
    ...
    with col4:
        ...
        st.metric(
            "F1 Score",
            f"{classification_metrics['F1 Score']:.2%}"
        )
    ...
    st.info(
        """
        Retrieval metrics evaluate how effectively the system retrieves
        relevant crime cases from distributed agency databases.

        Classification metrics evaluate overall prediction quality using
        Accuracy, Precision, Recall, and F1 Score.

        Together these metrics provide a comprehensive assessment of
        retrieval effectiveness and system performance.
        """
    )
